const API_KEY  = 'bd933a84ed6da7cb030d099f0d18fb87';
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 lancamento-poster">
							<a target="_blank" class="text-info" href="/detalhes.html?id=${filme.id}">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-10">
								...
								<h6 class="card-subtitle mb-2 text-muted">Sobre <a target="_blank" href="/detalhes.html?id=${dados.id}" class="text-info">${nomeFilme}</a></h6>
	...
	for (i = 0; i < 4; i++) {
		...
		texto += `
			<div class="filme-destaque col-12 col-md-6 col-lg-3 thumbnail ">
				<a target="_blank" href="/detalhes.html?id=${filme.id}">
